...
public abstract class Product {
  ...
  private com.mikpolv.intensive28.homework.jdbc.enteties.Brand brand;
  ...
  private Set<com.mikpolv.intensive28.homework.jdbc.enteties.Supplier> suppliers = new HashSet<>();

  public Product() {}

  public Product(@NotNull String productName, com.mikpolv.intensive28.homework.jdbc.enteties.Brand brand) {
    this.productName = productName;
    this.brand = brand;
  }

  public Product(int id, @NotNull String productName, com.mikpolv.intensive28.homework.jdbc.enteties.Brand brand) {
    this.id = id;
    this.productName = productName;
    this.brand = brand;
  }
  ...
  public com.mikpolv.intensive28.homework.jdbc.enteties.Brand getBrand() {
    return brand;
  }
  ...
  public Set<com.mikpolv.intensive28.homework.jdbc.enteties.Supplier> getSuppliers() {
    return suppliers;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof com.mikpolv.intensive28.homework.jdbc.enteties.Product product)) return false;
