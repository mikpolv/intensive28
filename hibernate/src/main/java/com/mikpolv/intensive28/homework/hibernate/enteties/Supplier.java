...
public class Supplier {
  ...
  private Set<com.mikpolv.intensive28.homework.jdbc.enteties.Product> products = new HashSet<>();
  ...
  private void removeSupplierAssociations() {
    for (com.mikpolv.intensive28.homework.jdbc.enteties.Product p : this.products) {
  ...
  public Set<com.mikpolv.intensive28.homework.jdbc.enteties.Product> getProducts() {
    return products;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof com.mikpolv.intensive28.homework.jdbc.enteties.Supplier supplier)) return false;
